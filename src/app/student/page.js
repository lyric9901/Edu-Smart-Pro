...
function StudentContent() {
    ...
    // ADDED COLORS AND SETTINGS TO THE NAV ITEMS ARRAY!
    const navItems = [
    ...
    return (
        <div className="flex min-h-screen font-sans transition-colors duration-300 select-none bg-[#05050a] text-zinc-100 relative overflow-hidden">
            ...
            {/* Ambient Glowing Orbs for Glassmorphism Background - Sleek Dark Neutral Tones */}
            ...
            <main className="flex-1 md:ml-72 relative z-10 flex flex-col min-h-screen">
                ...
                {/* Mobile Header - GREETINGS REMOVED! */}
                ...
                {/* Desktop Header - GREETINGS REMOVED! */}
                <header className="hidden md:flex items-center justify-between px-10 py-8">
                    ...
                    <div className="flex items-center gap-4">
                        {/* We removed the explicit settings button from the top right here because it is now perfectly in the sidebar/grid array! */}
                    </div>
                </header>
                                        ...
                                        {Array.from({ length: new Date(viewDate.getFullYear(), viewDate.getMonth() + 1, 0).getDate() }).map((_, i) => {
                                            ...
                                            return (
                                                <div key={day} className="flex flex-col items-center gap-2">
                                                    ...
                                                    {status === 'absent' && <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} className="w-2 h-2 md:w-2.5 md:h-2.5 rounded-full bg-rose-500 shadow-[0_0_12px_rgba(244,63,94,0.8)]" />}
                                                </div>
                                            );
                                        })}
                                    </div>
