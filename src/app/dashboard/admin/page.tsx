...
export default function AdminDashboard() {
  ...
  return (
    <div className="w-full text-slate-900 dark:text-slate-100 transition-colors duration-300 font-sans p-4 md:p-8">
      <AnimatePresence>
      ...
      <div className="w-full max-w-5xl mx-auto space-y-6">
        ...
        <div className="md:hidden relative w-full mx-auto bg-gradient-to-br from-indigo-500/10 to-blue-500/5 dark:from-indigo-900/30 dark:to-blue-900/20 backdrop-blur-2xl border border-white/40 dark:border-white/10 rounded-[2rem] shadow-[0_8px_32px_0_rgba(31,38,135,0.1)] p-6 mb-4 flex flex-row items-center justify-between overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-start w-[55%]">
            ...
            <div className="bg-white dark:bg-slate-800/60 backdrop-blur-md px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-700/80 font-mono font-black text-blue-600 dark:text-blue-400 shadow-inner w-full mb-3">
        ...
        <div className="md:hidden grid grid-cols-3 gap-3 mb-6 relative z-10">
            <button onClick={() => setShowAllBatches(true)} className="flex flex-col items-center justify-center gap-2.5 py-4 bg-white dark:bg-slate-800/60 backdrop-blur-xl border border-slate-200 dark:border-slate-700/80 rounded-[1.5rem] shadow-sm hover:scale-105 transition">
            ...
            <Link href="/dashboard/notices" className="flex flex-col items-center justify-center gap-2.5 py-4 bg-white dark:bg-slate-800/60 backdrop-blur-xl border border-slate-200 dark:border-slate-700/80 rounded-[1.5rem] shadow-sm hover:scale-105 transition">
            ...
            <Link href="/dashboard/attendance" className="flex flex-col items-center justify-center gap-2.5 py-4 bg-white dark:bg-slate-800/60 backdrop-blur-xl border border-slate-200 dark:border-slate-700/80 rounded-[1.5rem] shadow-sm hover:scale-105 transition">
        ...
        {!selectedBatch && (
            <div className="md:hidden bg-white dark:bg-slate-800/60 backdrop-blur-md p-6 rounded-[2rem] shadow-sm border border-slate-200 dark:border-slate-700/80 mb-6">
                ...
                <div className="flex gap-4">
                    <div className="flex-1 bg-white dark:bg-slate-800/60 p-4 rounded-2xl shadow-inner border border-slate-200 dark:border-slate-700/80 flex flex-col items-center justify-center text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 relative">
          ...
          <motion.div 
            ...
            className={`bg-white dark:bg-slate-800/60 backdrop-blur-md p-5 rounded-[2rem] shadow-sm border border-slate-200 dark:border-slate-700/80 h-fit ${selectedBatch ? 'hidden lg:block' : 'hidden md:block'}`}
          >
            ...
            <div className="flex gap-2 mb-4">
              <input 
                ...
                className="flex-1 bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/80 p-3 rounded-xl text-sm outline-none focus:ring-2 focus:ring-blue-500 transition-all font-medium text-zinc-800 dark:text-zinc-200"
              />
            ...
            <div className="space-y-2">
              {loading ? (
                  <>
                    <div className="flex items-center justify-between p-4 border border-slate-200 dark:border-slate-700/80 rounded-2xl"><Skeleton className="h-4 w-24"/><Skeleton className="h-6 w-8 rounded-full"/></div>
                    <div className="flex items-center justify-between p-4 border border-slate-200 dark:border-slate-700/80 rounded-2xl"><Skeleton className="h-4 w-32"/><Skeleton className="h-6 w-8 rounded-full"/></div>
                  </>
              ) : batches.length > 0 ? (
                  <>
                    {batches.slice(0, 5).map(batch => (
                        ...
                        <span className="text-xs bg-white dark:bg-slate-800/60 px-2.5 py-1 rounded-full border border-slate-200 dark:border-slate-700/80 text-zinc-500 font-bold shadow-sm">
                  ...
                  <div className="text-center py-10 border-2 border-dashed border-slate-200 dark:border-slate-700/80 rounded-2xl">
          ...
          >
            {selectedBatch ? (
              <div className="bg-white dark:bg-slate-800/60 backdrop-blur-md p-6 rounded-[2rem] shadow-sm border border-slate-200 dark:border-slate-700/80 min-h-[500px] flex flex-col">
                <div className="flex flex-col md:flex-row justify-between md:items-center mb-6 pb-6 border-b border-gray-200 dark:border-slate-700/80 gap-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                        {isEditingBatch ? (
                            <div className="flex items-center gap-3 mb-1">
                                <input 
                                    ...
                                    className="bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/80 py-1.5 px-3 rounded-xl text-2xl md:text-3xl font-black text-black dark:text-white outline-none focus:border-blue-500 transition-colors w-full md:w-auto"
                                    autoFocus
                                />
                        ...
                        <div className="flex items-center gap-3 mt-2">
                          <span className="text-xs text-zinc-500 dark:text-zinc-400 font-medium bg-white dark:bg-slate-800/60 px-3 py-1 rounded-lg border border-slate-200 dark:border-slate-700/80 shadow-sm flex items-center gap-1">
                    ...
                    <div className="flex gap-2 w-full md:w-auto">
                        <div className="relative flex-1">
                            ...
                            <input 
                                ...
                                className="pl-9 pr-4 py-2.5 w-full bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/80 rounded-xl text-sm outline-none focus:border-blue-500 transition-colors text-zinc-800 dark:text-zinc-200"
                                value={searchQuery}
                        ...
                        <button 
                            ...
                            className="bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-200 px-4 py-2 rounded-xl text-xs font-bold hover:bg-zinc-200 dark:hover:bg-zinc-700 transition flex items-center gap-2 border border-slate-200 dark:border-slate-700/80"
                        >
                ...
                {batchTab === "students" && (
                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
                        ...
                        <div className="hidden md:flex flex-col gap-3 mb-6 bg-white dark:bg-slate-800/60 p-5 rounded-2xl border border-slate-200 dark:border-slate-700/80 shadow-sm">
                            <div className="flex flex-col md:flex-row gap-3">
                                <div className="relative flex-1">
                                    <UserPlus size={18} className="absolute left-4 top-3.5 text-zinc-500"/>
                                    <input 
                                        placeholder="Student Name" 
                                        className="w-full pl-11 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700/80 p-3 rounded-xl text-sm outline-none focus:border-blue-500 transition-colors font-medium text-zinc-800 dark:text-zinc-200"
                                ...
                                <input 
                                    ...
                                    className="w-full md:w-48 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700/80 p-3 rounded-xl text-sm outline-none focus:border-blue-500 transition-colors font-medium text-zinc-800 dark:text-zinc-200"
                        ...
                        <div className="overflow-x-auto rounded-[1.5rem] border border-slate-200 dark:border-slate-700/80 shadow-sm mt-4 md:mt-0">
                            <table className="w-full text-left text-sm">
                                ...
                                <tbody className="divide-y divide-gray-100 dark:divide-zinc-800/50 bg-white dark:bg-slate-800/50">
                                <AnimatePresence>
                                {filteredStudents.map((student, i) => (
                                    ...
                                    <td className="p-5">
                                        <span className={`px-3 py-1.5 rounded-lg text-xs font-black tracking-wide border shadow-sm ${
                                            !student.performance ? "bg-gray-100 dark:bg-zinc-900 text-zinc-500 border-gray-200 dark:border-slate-700/80" 
                                ...
                                {filteredStudents.length === 0 && (
                                    <tr><td colSpan="4" className="p-16 text-center text-zinc-500 font-medium bg-slate-50 dark:bg-slate-900/50/30 border-dashed">No students found in this batch.</td></tr>
                                )}
                                </tbody>
                            </table>
                        </div>
                ...
                {batchTab === "analytics" && (
                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="bg-gradient-to-br from-white to-gray-50 dark:from-zinc-900 dark:to-black p-6 rounded-[1.5rem] border border-slate-200 dark:border-slate-700/80 shadow-sm relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            <div className="lg:col-span-2 bg-slate-50 dark:bg-slate-900/50 p-6 rounded-[1.5rem] border border-slate-200 dark:border-slate-700/80 shadow-sm h-[400px] flex flex-col">
                                ...
                                <div className="flex-1 w-full min-h-0">
                                    {batchAnalytics.chartData.length > 0 ? (
                                        ...
                                        <div className="h-full flex items-center justify-center border-2 border-dashed border-slate-200 dark:border-slate-700/80 rounded-2xl text-zinc-500 font-medium">
                            ...
                            <div className="space-y-6">
                                <div className="bg-white dark:bg-slate-800/60 p-6 rounded-[1.5rem] border border-slate-200 dark:border-slate-700/80 shadow-sm">
                                    ...
                                    <div className="space-y-3">
                                        {batchAnalytics.topPerformers.length > 0 ? batchAnalytics.topPerformers.map((student, i) => (
                                            <div key={student.id} className="flex justify-between items-center bg-slate-50 dark:bg-slate-900/50 p-3 rounded-xl border border-slate-200 dark:border-slate-700/80">
                                                <div className="flex items-center gap-3">
              ...
              <div className="h-full hidden md:flex flex-col items-center justify-center bg-slate-50 dark:bg-slate-900/50 rounded-[2rem] border-2 border-dashed border-slate-200 dark:border-slate-700/80 text-zinc-500 p-10 min-h-[500px]">
                ...
                <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="bg-white dark:bg-slate-800/60 rounded-[2rem] w-full max-w-sm overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-700/80">
                    ...
                    <div className="p-6 space-y-4">
                        <input 
                            ...
                            className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700/80 p-4 rounded-xl text-sm outline-none focus:border-blue-500 transition-all font-medium text-zinc-800 dark:text-zinc-200"
                            autoFocus
                        />
                        <motion.button 
                            whileTap={{ scale: 0.95 }} 
                ...
                <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="bg-white dark:bg-slate-800/60 rounded-[2rem] w-full max-w-sm overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-700/80">
                    ...
                    <div className="p-6 space-y-4">
                        <input 
                            ...
                            className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700/80 p-4 rounded-xl text-sm outline-none focus:border-green-500 transition-colors font-medium text-zinc-800 dark:text-zinc-200"
                            value={newStudent.name}
                            onChange={e => setNewStudent({...newStudent, name: e.target.value})}
                            autoFocus
                        />
                    ...
                    <div className="p-4 overflow-y-auto flex-1 space-y-2 custom-scrollbar">
                        {batches.map(batch => (
                            <motion.button 
                                ...
                                className="w-full p-4 rounded-2xl flex justify-between items-center transition-all bg-slate-50 dark:bg-slate-900/50 hover:bg-gray-100 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300 border border-transparent shadow-sm"
                            >
                                <span className="font-bold">{batch.name}</span>
                                <span className="text-xs bg-white dark:bg-slate-800/60 px-3 py-1 rounded-full text-zinc-500 font-bold shadow-sm">{batch.students?.length || 0} Students</span>
                            </motion.button>
                        ))}
                        {batches.length === 0 && (
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-[120]">
                <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="bg-white dark:bg-slate-800/60 rounded-[2rem] w-full max-w-sm overflow-hidden shadow-2xl relative border border-slate-200 dark:border-slate-700/80">
                    ...
                    <div className="p-8 flex flex-col items-center text-center">
                        ...
                        <div className="bg-white dark:bg-slate-800/60 p-4 rounded-2xl border-2 border-slate-200 dark:border-slate-700/80 shadow-sm mb-6">
                             <QRCodeSVG value={magicLinkUrl} size={200} level={"H"} includeMargin={true} id="magic-qr" />
                        </div>

                        <div className="w-full bg-slate-50 dark:bg-slate-900/50 p-3 rounded-xl border border-slate-200 dark:border-slate-700/80 flex items-center gap-2 mb-4">
                        ...
                        {batches.map(batch => (
                            <motion.button 
                                ...
                                className={`w-full p-4 rounded-2xl flex justify-between items-center transition-all ${
                                    ...
                                    : "bg-slate-50 dark:bg-slate-900/50 hover:bg-gray-100 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300 border border-transparent shadow-sm"
                                }`}
                            >
                                <span className="font-bold">{batch.name}</span>
                                <span className="text-xs bg-white dark:bg-slate-800/60 px-3 py-1 rounded-full text-zinc-500 font-bold shadow-sm">{batch.students?.length || 0} Students</span>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 z-[120]">
              <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="bg-white dark:bg-slate-800/60 rounded-[2rem] w-full max-w-md max-h-[90vh] overflow-y-auto custom-scrollbar shadow-2xl border border-slate-200 dark:border-slate-700/80 flex flex-col">
                  ...
                  <div className="p-4 sm:p-6 space-y-6 shrink-0">
                      ...
                      <div className="bg-slate-50 dark:bg-slate-900/50 p-6 rounded-[1.5rem] border border-slate-200 dark:border-slate-700/80 shadow-sm">
